...
\usepackage{tikz}
\usepackage{enumitem}
\usepackage[top=3cm, bottom=3cm, left=3.5cm, right=3.5cm, footskip=1.3cm]{geometry}
...
\usepackage{etoolbox}
\makeatletter
\preto\subsection{\@afterindenttrue}
\preto\subsubsection{\@afterindenttrue}
\makeatother
\setlength{\parindent}{15pt}
\setlength{\parskip}{0pt} % facultatif selon le style voulu

\typeout{parindent=\the\parindent, parskip=\the\parskip}
...
\scalebox{0.23540867}{%
  \begin{tikzpicture}[x=1cm,y=1cm]
    ...
    \clip (-12.745995,-13.589511) rectangle (12.533908,14.022047);

    % Voronoi edges (first diagram)
    \draw[black, line width=0.6pt] (-0.559627,-8.787743) -- (2.520338,-4.530391);
    \draw[black, line width=0.6pt] (12.066653,5.518914) -- (3.847612,7.546636);
    \draw[black, line width=0.6pt] (3.832608,7.649620) -- (3.847612,7.546636);
    \draw[black, line width=0.6pt] (0.057146,9.406985) -- (3.832608,7.649620);
    \draw[black, line width=0.6pt] (-0.559627,-8.787743) -- (-1.531859,-7.996630);
    \draw[black, line width=0.6pt] (2.565288,-3.332525) -- (2.520338,-4.530391);
    \draw[black, line width=0.6pt] (2.565288,-3.332525) -- (0.405454,-2.925077);
    \draw[black, line width=0.6pt] (0.405454,-2.925077) -- (-1.788788,-3.022933);
    \draw[black, line width=0.6pt] (-1.788788,-3.022933) -- (-3.976994,-3.947916);
    \draw[black, line width=0.6pt] (-1.531859,-7.996630) -- (-3.976994,-3.947916);
    \draw[black, line width=0.6pt] (-1.531859,-7.996630) -- (-28.426955,-9.496830);
    \draw[black, line width=0.6pt] (3.250202,-2.298963) -- (4.508926,3.819139);
    \draw[black, line width=0.6pt] (3.250202,-2.298963) -- (3.297492,-2.571060);
    \draw[black, line width=0.6pt] (3.297492,-2.571060) -- (5.941640,-2.389622);
    \draw[black, line width=0.6pt] (5.941640,-2.389622) -- (8.077771,3.837573);
    \draw[black, line width=0.6pt] (8.077771,3.837573) -- (4.508926,3.819139);
    \draw[black, line width=0.6pt] (3.556407,4.392998) -- (4.508926,3.819139);
    \draw[black, line width=0.6pt] (3.556407,4.392998) -- (1.945683,4.280446);
    \draw[black, line width=0.6pt] (1.439579,0.463548) -- (1.945683,4.280446);
    \draw[black, line width=0.6pt] (1.439579,0.463548) -- (3.250202,-2.298963);
    \draw[black, line width=0.6pt] (2.565288,-3.332525) -- (3.297492,-2.571060);
    \draw[black, line width=0.6pt] (12.066653,5.518914) -- (8.077771,3.837573);
    \draw[black, line width=0.6pt] (3.556407,4.392998) -- (3.847612,7.546636);
    \draw[black, line width=0.6pt] (-497.595649,691.320109) -- (-7.941075,5.198040);
    \draw[black, line width=0.6pt] (-28.426955,-9.496830) -- (-13.436426,-3.878541);
    \draw[black, line width=0.6pt] (-7.941075,5.198040) -- (-13.436426,-3.878541);
    \draw[black, line width=0.6pt] (0.057146,9.406985) -- (-1.063683,6.335252);
    \draw[black, line width=0.6pt] (1.945683,4.280446) -- (0.283933,4.694136);
    \draw[black, line width=0.6pt] (-1.063683,6.335252) -- (0.283933,4.694136);
    \draw[black, line width=0.6pt] (1.439579,0.463548) -- (-1.285312,1.617184);
    \draw[black, line width=0.6pt] (0.283933,4.694136) -- (-1.285312,1.617184);
    \draw[black, line width=0.6pt] (0.405454,-2.925077) -- (-1.336338,1.582244);
    \draw[black, line width=0.6pt] (-1.788788,-3.022933) -- (-2.440309,1.279272);
    \draw[black, line width=0.6pt] (-2.440309,1.279272) -- (-1.336338,1.582244);
    \draw[black, line width=0.6pt] (-1.285312,1.617184) -- (-1.336338,1.582244);
    \draw[black, line width=0.6pt] (-4.341965,6.005219) -- (-6.368652,4.551811);
    \draw[black, line width=0.6pt] (-4.341965,6.005219) -- (-4.194690,5.936870);
    \draw[black, line width=0.6pt] (-4.194690,5.936870) -- (-3.870936,1.525256);
    \draw[black, line width=0.6pt] (-6.368652,4.551811) -- (-11.028557,-3.071093);
    \draw[black, line width=0.6pt] (-3.870936,1.525256) -- (-10.614183,-3.003518);
    \draw[black, line width=0.6pt] (-10.614183,-3.003518) -- (-11.028557,-3.071093);
    \draw[black, line width=0.6pt] (-497.595649,691.320109) -- (-4.341965,6.005219);
    \draw[black, line width=0.6pt] (-7.941075,5.198040) -- (-6.368652,4.551811);
    \draw[black, line width=0.6pt] (-1.063683,6.335252) -- (-4.194690,5.936870);
    \draw[black, line width=0.6pt] (-2.440309,1.279272) -- (-3.870936,1.525256);
    \draw[black, line width=0.6pt] (-13.436426,-3.878541) -- (-11.028557,-3.071093);
    \draw[black, line width=0.6pt] (-3.976994,-3.947916) -- (-10.614183,-3.003518);
    \draw[black, line width=0.6pt] (-0.559627,-8.787743) -- (20.922242,-191.607026);
    \draw[black, line width=0.6pt] (2.520338,-4.530391) -- (112.537819,-152.112621);
    \draw[black, line width=0.6pt] (12.066653,5.518914) -- (186.021343,65.719635);
    \draw[black, line width=0.6pt] (3.832608,7.649620) -- (113.771986,155.290041);
    \draw[black, line width=0.6pt] (0.057146,9.406985) -- (-16.481893,192.739527);
    \draw[black, line width=0.6pt] (-28.426955,-9.496830) -- (-202.949701,-68.030342);
    \draw[black, line width=0.6pt] (5.941640,-2.389622) -- (176.685657,-71.170734);
    \draw[black, line width=0.6pt] (-497.595649,691.320109) -- (-605.011911,840.806254);

    % Non-adjacent points (black, larger) - first diagram
    \fill[black] (-8.532678,4.900976) circle (6.0pt);
    \fill[black] (8.320590,0.005979) circle (6.0pt);
    \fill[black] (-3.023055,8.860025) circle (6.0pt);
    \fill[black] (5.714295,7.537075) circle (6.0pt);
    \fill[black] (-7.467810,5.660925) circle (6.0pt);
    \fill[black] (-3.043220,-0.757295) circle (6.0pt);
    \fill[black] (-5.670705,3.154975) circle (6.0pt);
    \fill[black] (-3.874567,-8.987585) circle (6.0pt);
    \fill[black] (2.061262,7.004836) circle (6.0pt);
    \fill[black] (-3.970242,-7.272364) circle (6.0pt);
    \fill[black] (-7.930073,4.536133) circle (6.0pt);
    \fill[black] (5.504544,6.686885) circle (6.0pt);
    \fill[black] (3.185505,9.420120) circle (6.0pt);
    \fill[black] (2.711346,-8.213718) circle (6.0pt);

    % Adjacent points (orange, larger) - first diagram
    \fill[orange] (-1.037827,-5.501394) circle (7.0pt);
    \fill[orange] (2.439032,1.598606) circle (7.0pt);
    \fill[orange] (0.770469,1.819850) circle (7.0pt);
    \fill[orange] (-2.328367,3.400257) circle (7.0pt);
    \fill[orange] (5.995725,-5.765327) circle (7.0pt);
    \fill[orange] (5.534116,0.961831) circle (7.0pt);
    \fill[orange] (-1.261431,-0.487463) circle (7.0pt);

    % Central point (red, larger) - first diagram
    \fill[red] (0.000000,0.000000) circle (7.0pt);

    % Black frame around the drawing (first)
    \draw[black, line width=1.8pt, draw opacity=0.950] (-12.745995,-13.589511) rectangle (12.533908,14.022047);

  \end{tikzpicture}%
}
\hspace{0.8cm}
\scalebox{0.23540867}{%
  \begin{tikzpicture}[x=1cm,y=1cm] % <-- coordinates in cm; scaled by \scalebox

    \clip (-12.745995,-13.589511) rectangle (12.533908,14.022047);

    % Voronoi edges (second diagram)
    \draw[black, line width=0.6pt] (86.426499,-9.960661) -- (9.232176,-1.275391);
    \draw[black, line width=0.6pt] (7.179789,5.713134) -- (9.232176,-1.275391);
    \draw[black, line width=0.6pt] (-7.984293,4.575056) -- (-7.716082,3.994574);
    \draw[black, line width=0.6pt] (-1.595823,7.462421) -- (-7.209741,3.572875);
    \draw[black, line width=0.6pt] (-7.716082,3.994574) -- (-7.209741,3.572875);
    \draw[black, line width=0.6pt] (-2.031432,-8.955756) -- (-4.092735,-6.924055);
    \draw[black, line width=0.6pt] (-4.092735,-6.924055) -- (-40.953573,-25.887031);
    \draw[black, line width=0.6pt] (-7.209741,3.572875) -- (-6.874556,2.173518);
    \draw[black, line width=0.6pt] (-13.690622,-1.604159) -- (-6.874556,2.173518);
    \draw[black, line width=0.6pt] (0.405454,-2.925077) -- (-4.541960,-3.145714);
    \draw[black, line width=0.6pt] (0.405454,-2.925077) -- (-1.336338,1.582244);
    \draw[black, line width=0.6pt] (-4.541960,-3.145714) -- (-5.573929,-2.048511);
    \draw[black, line width=0.6pt] (-1.336338,1.582244) -- (-5.799349,0.357426);
    \draw[black, line width=0.6pt] (-5.799349,0.357426) -- (-5.620772,-1.798834);
    \draw[black, line width=0.6pt] (-5.573929,-2.048511) -- (-5.620772,-1.798834);
    \draw[black, line width=0.6pt] (-4.092735,-6.924055) -- (-4.541960,-3.145714);
    \draw[black, line width=0.6pt] (-40.953573,-25.887031) -- (-5.573929,-2.048511);
    \draw[black, line width=0.6pt] (-13.690622,-1.604159) -- (-5.620772,-1.798834);
    \draw[black, line width=0.6pt] (-6.874556,2.173518) -- (-5.799349,0.357426);
    \draw[black, line width=0.6pt] (86.426499,-9.960661) -- (8.240374,-7.579608);
    \draw[black, line width=0.6pt] (9.232176,-1.275391) -- (7.884069,-2.256335);
    \draw[black, line width=0.6pt] (8.240374,-7.579608) -- (7.884069,-2.256335);
    \draw[black, line width=0.6pt] (7.179789,5.713134) -- (4.508938,3.819198);
    \draw[black, line width=0.6pt] (7.884069,-2.256335) -- (3.297492,-2.571060);
    \draw[black, line width=0.6pt] (3.297492,-2.571060) -- (3.250202,-2.298963);
    \draw[black, line width=0.6pt] (3.250202,-2.298963) -- (4.508938,3.819198);
    \draw[black, line width=0.6pt] (5.768801,-14.910320) -- (5.921438,-9.937631);
    \draw[black, line width=0.6pt] (5.768801,-14.910320) -- (-1.640145,-8.913239);
    \draw[black, line width=0.6pt] (5.921438,-9.937631) -- (2.462876,-6.061686);
    \draw[black, line width=0.6pt] (-1.640145,-8.913239) -- (2.462876,-6.061686);
    \draw[black, line width=0.6pt] (8.240374,-7.579608) -- (5.921438,-9.937631);
    \draw[black, line width=0.6pt] (-2.031432,-8.955756) -- (-1.640145,-8.913239);
    \draw[black, line width=0.6pt] (2.565288,-3.332525) -- (2.462876,-6.061686);
    \draw[black, line width=0.6pt] (2.565288,-3.332525) -- (3.297492,-2.571060);
    \draw[black, line width=0.6pt] (0.405454,-2.925077) -- (2.565288,-3.332525);
    \draw[black, line width=0.6pt] (0.066678,4.268145) -- (-1.285312,1.617184);
    \draw[black, line width=0.6pt] (0.066678,4.268145) -- (1.860098,3.634991);
    \draw[black, line width=0.6pt] (1.860098,3.634991) -- (1.439579,0.463548);
    \draw[black, line width=0.6pt] (-1.285312,1.617184) -- (1.439579,0.463548);
    \draw[black, line width=0.6pt] (-1.595823,7.462421) -- (0.066678,4.268145);
    \draw[black, line width=0.6pt] (-1.336338,1.582244) -- (-1.285312,1.617184);
    \draw[black, line width=0.6pt] (4.508938,3.819198) -- (1.860098,3.634991);
    \draw[black, line width=0.6pt] (3.250202,-2.298963) -- (1.439579,0.463548);
    \draw[black, line width=0.6pt] (-7.984293,4.575056) -- (24.475587,236.208422);
    \draw[black, line width=0.6pt] (-7.984293,4.575056) -- (-185.849839,156.468135);
    \draw[black, line width=0.6pt] (7.179789,5.713134) -- (84.056061,226.615146);
    \draw[black, line width=0.6pt] (86.426499,-9.960661) -- (319.502705,-29.534686);
    \draw[black, line width=0.6pt] (-1.595823,7.462421) -- (68.997043,230.451899);
    \draw[black, line width=0.6pt] (-2.031432,-8.955756) -- (-90.924558,-225.301942);
    \draw[black, line width=0.6pt] (-40.953573,-25.887031) -- (-241.716100,-145.895647);
    \draw[black, line width=0.6pt] (-7.716082,3.994574) -- (-237.249285,-40.973955);
    \draw[black, line width=0.6pt] (-13.690622,-1.604159) -- (-231.334466,-87.271055);
    \draw[black, line width=0.6pt] (5.768801,-14.910320) -- (56.694366,-243.195770);

    % Black points added for second diagram (larger)
    \fill[black] (-5.656398,8.203721) circle (6.0pt);
    \fill[black] (-10.136452,-1.222473) circle (6.0pt);
    \fill[black] (10.223211,-5.482367) circle (6.0pt);
    \fill[black] (-5.471063,-9.999220) circle (6.0pt);
    \fill[black] (-12.256400,5.154195) circle (6.0pt);
    \fill[black] (-7.396057,-6.257354) circle (6.0pt);
    \fill[black] (-0.319073,-12.116088) circle (6.0pt);
    \fill[black] (1.767642,-9.538107) circle (6.0pt);
    \fill[black] (2.151592,5.731907) circle (6.0pt);
    \fill[black] (-10.158991,-2.156780) circle (6.0pt);
    \fill[black] (-11.483176,1.207423) circle (6.0pt);
    \fill[black] (11.133268,2.606187) circle (6.0pt);
    \fill[black] (10.091917,-9.793620) circle (6.0pt);
    \fill[black] (-9.225103,8.703820) circle (6.0pt);

    % Adjacent points (orange, larger) - second diagram
    \fill[orange] (-1.037827,-5.501394) circle (7.0pt);
    \fill[orange] (2.439032,1.598606) circle (7.0pt);
    \fill[orange] (0.770469,1.819850) circle (7.0pt);
    \fill[orange] (-2.328367,3.400257) circle (7.0pt);
    ...
    % Central point (red, larger) - second diagram
    \fill[red] (0.000000,0.000000) circle (7.0pt);

    % Black frame around the drawing (second)
    \draw[black, line width=1.8pt, draw opacity=0.950] (-12.745995,-13.589511) rectangle (12.533908,14.022047);
